...
function initFloor(index) {
  ...
  return {
    ...
    elevator: { x: -130, y: 390, width: 68, height: 68, carrying: 0, isMoving: false, direction: 1, state: "idle", maxCapacity: 130 },
    storage: { x: 1100, y: 430, width: 45, height: 45, carrying: 0, isCollecting: false, state: "idle", currentSprite: null, initialX: 1100, maxCapacity: 100, collectionTime: 500 },
